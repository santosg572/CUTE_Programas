...
for i=1:2
    res1 = fun1_Mod_5BIS(i, delt, v, w, landa);
    if mod(i,1)== 2
        figure(1)
        subplot(2,1,1)
        plot(res1.uy)
    ...
    res2 = fun2_Mod_5BIS(delt, res1.uy, res1.ux, res1.x);
    v = res2.v;
    w = res2.w;
    landa = res2.landa;
%end
...
hold on
%plot(x.^2 + y.^2 + z.^2)
surf(xx,yy,zz, 'FaceAlpha',0.3, 'EdgeColor', 'none') % none
shading interp
colormap(gray)
if i == 2
